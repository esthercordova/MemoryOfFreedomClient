...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).done(ui.changePasswordSuccess).fail(ui.passwordFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var passwordFailure = function passwordFailure() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSaveNote = function onSaveNote(event) {
	  return new Promise(function (resolve, reject) {
	    event.preventDefault();
	    var question_id = $('.giveQuestionId').attr('data-id') - 1;
	    var user_id = app.user.id;
	...
	var onDeleteNote = function onDeleteNote(event) {
	  return new Promise(function (resolve, reject) {
	    event.preventDefault();
	    var question_id = $('.giveQuestionId').attr('data-id') - 1;
	    var user_id = app.user.id;
	...
	var onDeleteQuestion = function onDeleteQuestion(event) {
	  return new Promise(function (resolve, reject) {
	    event.preventDefault();

	    var question_id = $('.giveQuestionId').attr('data-id');
	    var user_id = app.user.id;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getJointTableId = function getJointTableId(question_id, user_id) {
	  return $.ajax({
	...
	var changeQuestionStatus = function changeQuestionStatus(user_id, question_id, status, notes, user_question_table_id) {
	  return $.ajax({
	    method: 'PATCH',
	    ...
	    data: { "user_question": { "status": status,
	        "user_id": user_id,
	        "question_id": question_id,
	        "notes": notes
	      }
	...
	var createUserQuestions = function createUserQuestions(data, question_id) {
	  return $.ajax({
	    url: app.host + '/user_questions',
	    method: "POST",
	    headers: {
	...
	var deleteNickname = function deleteNickname() {
	  return new Promise(function (resolve, reject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changeQuestionStatusSuccess = function changeQuestionStatusSuccess(data) {
	  if (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1>Memory of Freedom</h1>\n\n<h4 class=\"giveQuestionId\" data-id="
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1>Memory of Freedom</h1>\n\n<div id=\"startQuestions\">\n  <h2> Let's start learning </h2>\n  <button id=\"start\" class=\"btn btn-info answerButton\">Let's start!</button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "315017d3b65a216f32b3bd9fe0d2ed9c.jpg";
